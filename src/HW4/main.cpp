...
AssetManager assets({{"sphere", // group
                      {{"model", "../resources/simple/sphere.obj"},
                       ...
                       {"albedo", "../resources/textures/wool/albedo.png"},
                       {"normal", "../resources/textures/wool/normal.png"},
                       {"metallness", "../resources/textures/wool/metallic.png"},
                       {"roughness", "../resources/textures/wool/roughness.png"},
                       {"ao", "../resources/textures/wool/ao.png"},
                       {"height", "../resources/textures/wool/height.png"}
                       }},
...
int main()
{
    ...
    unsigned int heightMap = assets.GetActiveAsset<Tex>("height");
    // build and compile shaders
    // -------------------------
    const std::string SRC = "../src/HW4/";
    ...
    shader.setInt("heightMap", 5); // Assuming texture unit 5
        ...
        if (gui)
        {
            ...
            // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
            {
                ...
                if (assets.GetActiveGroupId() != item_current)
                {
                    ...
                    heightMap = assets.GetActiveAsset<Tex>("height");
                }
